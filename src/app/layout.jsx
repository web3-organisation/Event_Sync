...
export default function RootLayout({ children }) {
  return (
    <html
      lang="fr"
      className={`${geistSans.variable} ${geistMono.variable} ${bricolage.variable} ${dmSans.variable}`}
      suppressHydrationWarning
    >
      {/* ✅ suppressHydrationWarning sur <head> pour éviter l'avertissement du <script> */}
